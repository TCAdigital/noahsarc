    ...
    <main className="bg-white text-stone-900 leading-relaxed min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="grid grid-cols-2 gap-6">
              {educationStats.map((stat, i) => (
                <Reveal key={i} className="bg-white p-6 rounded-3xl shadow-lg border border-stone-100 hover:shadow-2xl transition duration-500" delay={i * 0.1}>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {spiritualPrograms.map((program, i) => (
              <Reveal key={i} className="group p-8 rounded-[2.5rem] bg-stone-50 border border-stone-100 hover:bg-emerald-900 hover:text-white transition-all duration-500 hover:shadow-2xl hover:-translate-y-2" delay={i * 0.1}>
      ...
      <section className="py-24 bg-emerald-950 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <Image
            src="/images/what-we-do-health.jpg"
            alt=""
            fill
            sizes="100vw"
            className="object-cover"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[4/5] rounded-[3rem] shadow-2xl overflow-hidden">
                <Image
                  src="/images/what-we-do-health.jpg"
                  alt="Health support in the community"
                  fill

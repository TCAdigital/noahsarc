...
export default async function Home() {
  ...
  return (
    <main className="bg-stone-50 text-stone-900 leading-relaxed overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative flex items-center text-white min-h-[85vh] py-24 overflow-hidden">
        <SiteImage
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-base md:text-lg mb-6 text-stone-200 leading-relaxed">
              {hero.description}
            </p>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="border-l-4 border-amber-500 pl-6">
                  <h3 className="text-xs uppercase font-black text-amber-600 tracking-widest mb-3">
                ...
                <div className="border-l-4 border-emerald-600 pl-6">
                  <h3 className="text-xs uppercase font-black text-emerald-600 tracking-widest mb-3">
                    {mission.visionTitle}
                  </h3>
      ...
      <section id="what-we-do" className="py-24 bg-stone-50 px-6">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-stone-600 text-lg font-medium mb-6">
              {whatWeDo.subtitle}
            </p>
      ...
      {/* Projects Section */}
      <section id="edu-fund" className="py-24 bg-stone-100 px-6">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              ...
              <SmartLink
                ...
                className="inline-flex items-center gap-3 bg-stone-900 text-white px-8 py-4 rounded-full font-bold uppercase text-[11px] tracking-[0.2em] hover:bg-emerald-800 transition shadow-xl"
              >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[400px] md:h-[500px]">
              <SiteImage
                ...
                alt="Students supported through sponsorship"
                fill
                sizes="(min-width: 768px) 50vw, 100vw"
                className="object-cover"
              />
          ...
          <div className="grid lg:grid-cols-2 items-center">
            <div className="max-w-xl">
              ...
              <div className="bg-emerald-900/60 backdrop-blur-md p-8 rounded-3xl border border-white/10 mb-8">
                <p className="text-emerald-50 mb-8 leading-relaxed text-sm border-l-2 border-amber-500 pl-4">
                  {sponsor.description}
                </p>
                  ...
                  {sponsor.stats.map((stat) => {
                    ...
                    return (
                      <div key={stat.label} className="flex items-center gap-4">
                        <div className="w-12 h-12 shrink-0 rounded-xl bg-white/10 flex items-center justify-center text-amber-400 border border-white/5">
                          <Icon size={20} />
                        </div>
                        <div>
      ...
      {/* Stay Connected */}
      <section id="stay-connected" className="py-24 bg-stone-50 px-6">
        <div className="container mx-auto px-6">
          <NewsletterSignup newsletter={newsletter} recipient={topBar.email} />
        </div>
      </section>
    </main>
  );
